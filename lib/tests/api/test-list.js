...
var TestList = function (_TestRest) {
    _inherits(TestList, _TestRest);

    function TestList() {
        _classCallCheck(this, TestList);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(TestList).apply(this, arguments));
    }
        ...
        value: function testLIST(opts) {
            ...
            if (opts.testFilter) {
                ...
                _lodash2.default.each(opts.testFilter, function (columnName, filterName) {
                    ...
                    that.callLIST(null, _this2.makeParam(opts, _defineProperty({}, filterName, seedValue)), function (fixture, response) {
