...
exports.Factory = exports.Directive = exports.Filter = exports.Service = exports.Config = exports.Run = exports.Inject = exports.RouteConfig = exports.View = exports.Component = exports.AbstractService = exports.MockHttp = exports.StateModel = exports.ParserHelper = exports.EnvironmentHelper = exports.DataCollection = exports.DataModel = exports.ValidationGeneratorHelper = undefined;
...
var CoreLoader = function () {
	...
	_createClass(CoreLoader, [{
		...
		value: function getConfigProperty(name) {
			if (_lodash2.default.has(this.config, name)) {
