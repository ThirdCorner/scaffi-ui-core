...
ParserHelper = {
    ...
    isNumberString: function isNumberString(value) {
         ...
         */
        if (_lodash2.default.isString(value) && value.length > 0 && !isNaN(value) && value[0] !== "0") {
            return true;
        }
        return false;
    },
    ...
    isFormController: function isFormController(item) {
                ...
                switch (true) {
                    ...
                    case ParserHelper.isDateString(value):
                        ...
                        if (value.indexOf("T") === -1 && value.indexOf("-") !== -1) {
                            ...
                            structure[key] = (0, _moment2.default)(new Date()).year(split[0]).month(parseInt(split[1], 10) - 1).date(split[2]).toDate();
                        } else {
