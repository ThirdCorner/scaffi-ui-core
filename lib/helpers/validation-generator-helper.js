...
exports.default = {
	...
	generateMessageDiv: function generateMessageDiv(scope, elem, allowedRestrictions, attrs) {
		var form = _parserHelper2.default.getFormController(angular.element(elem).scope());
		if (!form) {
			console.log(scope);
