...
var DataModel = function () {
     ...
     */
				...
				if (value instanceof DataCollection && _lodash2.default.has(data, key)) {
		...
		value: function convertToDataCollection(key, value) {
			if (_lodash2.default.isArray(value) && !(value instanceof DataCollection)) {
		...
		value: function save() {
			var that = this;
			this._service.save(this.export()).then(function (data) {
				if (data[ID_PROP]) {
