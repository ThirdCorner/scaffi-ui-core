    ...
    (0, _createClass3.default)(AbstractService, [{
        ...
        value: function getCacheResource() {
            ...
            return new _promise2.default(function (resolve, reject) {
                if (_this.cachedResource) {
                    resolve(_this.cachedResource);
                } else {
                    _this.resource().then(function (data) {
                        _this.cachedResource = data;
                        resolve(data);
                    });
                }
            });
        ...
        value: function resource(id) {
            ...
            return this.$http.get(url).then(function (response) {
                ...
                if (that.isSuccessJson(response)) {
                    ...
                    var returnData = _this2.stateStore.registerRequest(_this2, url, response.data);
                    if (!id) {
                        _this2.cachedResource = returnData;
                    }
        ...
        value: function list(params) {
            ...
            return this.$http.get(url, { params: params }).then(function (response) {
                ...
                if (that.isSuccessJson(response)) {
                    ...
                    return _this4.stateStore.registerRequest(_this4, url, responseData);
                }
                ...
                return _this4.stateStore.registerRequest(_this4, url, data);
            }).catch(function (response) {
                that.sendToTestUIHarnessResponse(response);
                return that.$rootScope.showResourceError(response);
            });
        ...
        value: function post(newResource, opts) {
            ...
            return this.$http.post(API_BASE + ('' + this.route), newResource).then(function (response) {
                ...
                if (that.isSuccessJson(response)) {
                    ...
                    if (!opts || !opts.silent) {
                        that.$rootScope.showSuccessToast(_this5._getCreatedToastMessage(response));
                    }
                    return response.data;
                }
                return that.addServerError(response);
                ...
                switch (true) {
                    ...
                    case _lodash2.default.isArray(value):
                        ...
                        _lodash2.default.each(value, function (item) {
                            returnArray.push(_this6.convertToObject(item));
                        }, _this6);
        ...
        key: 'addServerError',
        value: function addServerError(response) {
            if (response && response.status == -1 && this.$rootScope.getEnvironment() == "prototype") {
                return response;
            }
            _errorLogging2.default.fireError("server", response);
